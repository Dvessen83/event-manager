...
visitor1 = Visitor.create! ( {first_name:"Caroline", last_name:"Olijve", age:38, image_url:"", payment_method:"cash", event_id:1})
visitor2 = Visitor.create! ( {first_name:"JT", last_name:"Breunissen", age:31, payment_method:"cash", event_id:1})
visitor3 = Visitor.create! ( {first_name:"Youri", last_name:"Harmsen", age:32, payment_method:"ideal", event_id:1})
visitor4 = Visitor.create! ( {first_name:"Dennis", last_name:"Van Essen", age: 33, payment_method:"creditcard", event_id:1})
